...
CREATE TABLE IF NOT EXISTS `pizzaStore`.`clients` (
  `NIF` VARCHAR(9) NULL COMMENT 'Vincula con la tabla persons',
...
-- -----------------------------------------------------
-- Table `pizzaStore`.`productsCategories`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzaStore`.`productsCategories` ;

CREATE TABLE IF NOT EXISTS `pizzaStore`.`productsCategories` (
  `ProductId` INT UNSIGNED NOT NULL,
  `CategoryId` INT UNSIGNED NOT NULL,
  UNIQUE INDEX `id_UNIQUE` (`ProductId` ASC) VISIBLE,
  INDEX `fkCategory_idx` (`CategoryId` ASC) VISIBLE,
